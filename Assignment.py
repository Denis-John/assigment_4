...
x0 = df.filter((col('CLASS') == 0)).select('X', monotonically_increasing_id().alias('id')).toPandas()
y0 = df.filter((col('CLASS') == 0)).select('Y', monotonically_increasing_id().alias('id')).toPandas()
z0 = df.filter((col('CLASS') == 0)).select('Z', monotonically_increasing_id().alias('id')).toPandas()
x1 = df.filter((col('CLASS') == 1)).select('X', monotonically_increasing_id().alias('id')).toPandas()
y1 = df.filter((col('CLASS') == 1)).select('Y', monotonically_increasing_id().alias('id')).toPandas()
z1 = df.filter((col('CLASS') == 1)).select('Z', monotonically_increasing_id().alias('id')).toPandas()
